...
tinymce.PluginManager.add('ptw_link', function(editor) {
	function renderLinkEditor() {
		var html = ''
		,	tagIn = '<div class="mce-not-inline mce-menu-item mce-menu-item-normal mce-first mce-stack-layout-item mce-link-row">'
		,	tagOut = '</div>';
		html += tagIn+ '<span class="mce-input-name-txt">link</span> <input id="' + editor.id + '_ptwPostLinkListField" type="text" name="href" value="">'+ tagOut;
		html += '<div style="display: none;" id="' + editor.id + 'ptwPostLinkList" class="ptwPostLinkList" data-postlink-to="#' + editor.id + '_ptwPostLinkListField"></div>';
	...
	function updateLinkWnd(e) {
		...
		if(!control._ptwInited) {
			...
			ptwInitCustomCheckRadio( linkWnd );
			control._ptwInited = true;
		}
		updateSelections(e);
		...
		ptwCheckUpdate( targetBlankCtrl );

		data.rel == 'nofollow'
			? relNofollow.attr('checked', 'checked')
			: relNofollow.removeAttr('checked');
		ptwCheckUpdate( relNofollow );
	}

	var tabPostsHeight = null,
		containerHeight = null;

	editor.addButton('ptw_link', {
		type: 'panelbutton'
	,	icon: 'link'
	...
	,	panel: {
		...
		,	onshow: function () {
			var fieldID = '#' + editor.id + '_ptwPostLinkListField',
				listID = '#' + editor.id + 'ptwPostLinkList',
